export const profileData = {
  ...
  social: {
    ...
    linkedIn: 'https://www.linkedin.com/in/hersvinfred',
  },
}
...
export const portfolioData = {
  categories: ['all', 'mobile', 'web development'],
  projects: [
    {
      title: 'HRIS - PHP',
      category: 'web development',
      image: '/image1.png',
      description: 'Full stack human resources information system',
      tech: ['PHP', 'Bootstrap', 'MySQL', "HTML", "CSS", "JS"],
      githubUrl: 'https://github.com/hersvin/HRIS-PHP',
    },
    {
      title: 'HRIS - React',
      category: 'web development',
      image: '/image1.png',
      description: 'Full stack human resources information system',
      tech: ['React', 'Bootstrap', 'MySQL', "HTML", "CSS", "JS"],
      githubUrl: 'https://github.com/hersvin/HRIS-REACT',
    },
    {
      title: 'Enterprise Resource Planning - SBF',
      category: 'web development',
      image: '/image1.png',
      description: 'Full stack human resources information system',
      tech: ['React', 'Bootstrap', 'MySQL', "HTML", "CSS", "JS"],
      githubUrl: 'https://github.com/hersvin/ERP_SBF',
    },
    {
      title: 'HRIS - Angular',
      category: 'web development',
      image: '/image1.png',
      description: 'Full stack human resources information system',
      tech: ['Angular', 'Ant Design', 'MONGO DB', "HTML", "CSS", "TS"],
      githubUrl: 'https://github.com/hersvin/HRIS-ANGULAR',
    },
    {
      title: 'BookAJob',
      category: 'mobile',
      image: '/image2.png',
      description: 'A navigation app containing a list of jobs done by professionals',
      tech: ['React Native', 'Laravel', 'Vue JS', "HTML", "CSS", "JS", "MySQL"],
      githubUrl: 'https://github.com/hersvin/BookAJob',
    },
    {
      ...
      tech: ['PHP', 'Bootstrap', 'MySQL', "HTML", "CSS", "JS"],
      githubUrl: 'https://github.com/hersvin/classroom-management-system',
    },
    {
      title: 'Funeral System',
      category: 'web development',
      image: '/image1.png',
      description: 'Modern portfolio design for creative professionals',
      tech: ['PHP', 'Bootstrap', 'MySQL', "HTML", "CSS", "JS"],
      githubUrl: 'https://github.com/hersvin/funeral-system',
    },
    {
      title: 'HRPocket',
      category: 'mobile',
      image: '/image2.png',
      description: 'A mobile app containing of hr services such as payroll, timekeeping and filing applications',
      tech: ['React', 'TailwindCSS', '.Net', 'TypeScript'],
      liveUrl: '',
      githubUrl: '',
    },
    {
      ...
      category: 'web development',
      image: '/image1.png',
      description: 'A web app containing of hr services such as payroll, timekeeping and filing applications',
      tech: ['React', 'TailwindCSS', '.Net', 'TypeScript', "MSSQL"],
      liveUrl: '',
      githubUrl: '',
    },
    {
      ...
      category: 'web development',
      image: '/image1.png',
      description: 'A web app that view a list of job positions and you can apply here',
      tech: ['React', '.Net', 'MSSQL', "TailwindCSS", "Zustand"],
      liveUrl: '',
      githubUrl: '',
    },
    {
      ...
      category: 'mobile',
      image: '/image2.png',
      description: 'A mobile app containing of IOT, which you can use camera to scan a QR Code to get your Ayuda',
      tech: ['Next.js', 'Sanity CMS', 'Stripe'],
      liveUrl: '',
      githubUrl: 'https://github.com/hersvin/AIYUDA',
    },
  ],
}
